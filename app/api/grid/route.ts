  ...
  try {
    ...
    await prisma.gridTile.createMany({
      data: tiles.map((tile: any, index: number) => ({
        ...
        sliderData: tile.sliderData ? (typeof tile.sliderData === "string" ? tile.sliderData : JSON.stringify(tile.sliderData)) : null,
  ...
  try {
    ...
    const newTile = await prisma.gridTile.create({
      data: {
        ...
        tileType: data.tileType || "image",
        sliderData: data.sliderData ? (typeof data.sliderData === "string" ? data.sliderData : JSON.stringify(data.sliderData)) : null,
