...
import { PageBlock, BLOCK_DEFINITIONS, BlockStyles } from '@/types/page-builder';
...
export type { BlockEditorProps, ContentEditorProps, StyleEditorProps, SettingsEditorProps, SpacingValue } from './types';
export { 
  SPACING_OPTIONS, 
  getSpacingPx, 
