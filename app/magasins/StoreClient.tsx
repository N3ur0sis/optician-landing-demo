        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center justify-between">
            ...
            <nav className="hidden md:flex items-center gap-6">
              <Link href="/" className="text-neutral-600 hover:text-amber-800 transition-colors duration-300">
                Accueil
              </Link>
              <Link href="/magasins" className="text-neutral-600 hover:text-amber-800 transition-colors duration-300">
                Magasins
              </Link>
            </nav>
          </div>
