...
const PageNavigation = ({
    ...
    const fetchNavigation = async () => {
      try {
        const response = await fetch(
          "/api/navigation/items?onlyPublished=true",
        );
        if (response.ok) {
  ...
  const backButtonTextClass = isHome
  ...
  const burgerBorderClass = isHome
              ...
              <div className="flex items-center h-16">
                <div className="flex items-center gap-6 min-w-[160px]">
                  {showBackButton ? (
                    ...
                    >
                      <div
                        className={`w-8 h-8 border flex items-center justify-center transition-colors duration-200 ${backButtonBorderClass}`}
                      >
                ...
                <div className="flex items-center justify-end min-w-[160px]">
                  ...
                  >
                    <div
                      className={`w-4 h-px transition-all duration-300 ${burgerLineColor} ${isMenuOpen ? "rotate-45 translate-y-1.5" : ""}`}
                    ></div>
                    <div
                      className={`w-4 h-px transition-all duration-300 ${burgerLineColor} ${isMenuOpen ? "opacity-0" : ""}`}
                    ></div>
                    <div
                      className={`w-4 h-px transition-all duration-300 ${burgerLineColor} ${isMenuOpen ? "-rotate-45 -translate-y-1.5" : ""}`}
                    ></div>
