...
const BentoCard = ({
  ...
  <div
    ...
    className={cn(
      ...
      "bg-white border border-gray-300 shadow-sm hover:shadow-lg transition-all",
      "transform-gpu",
      className,
    )}
  >
    ...
    >
      <Button variant="ghost" asChild size="sm" className="pointer-events-auto text-black hover:text-black">
        <a href={href}>
          {cta}
