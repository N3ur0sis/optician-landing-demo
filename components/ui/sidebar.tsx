...
export const DesktopSidebar = ({
  ...
  return (
    <motion.div
      className={cn(
        "h-full px-4 py-4 hidden md:flex md:flex-col bg-white border-r border-gray-200 w-[320px] flex-shrink-0",
        className
      )}
      animate={{
...
export const SidebarLink = ({
  ...
  return (
    <Link
      href={link.href}
      className={cn(
        "flex items-center justify-start gap-2 group/sidebar py-2 px-3 rounded-lg hover:bg-gray-100 transition-colors",
        className
      )}
      {...props}
    >
